<script lang="ts">
	...
	import type { AppMode, SimulationCard as SimulationCardType } from '$lib/types.js';
...
<div class="grid min-h-screen grid-cols-1 gap-6 p-6 md:grid-cols-[320px_1fr] print:hidden">
	<!-- Sidebar -->
